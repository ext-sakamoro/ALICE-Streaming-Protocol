...
- `video_codec` unit tests: symbol mapping law (exact below 256 levels, error < step + ½ above), `CompressedFrame` wire layout round trip with every prefix and inflated histogram length rejected

...
pub mod alice {
    ...
    pub mod asp {
     ...
     .finish();
        ...
        impl Default for ColorPaletteArgs<'_> {
            #[inline]
            fn default() -> Self {
                ColorPaletteArgs {
                    colors: None,
     ...
     .finish();
        ...
        impl Default for RegionDescriptorArgs<'_> {
            #[inline]
            fn default() -> Self {
        ...
        impl Default for IPacketPayloadArgs<'_> {
            #[inline]
            fn default() -> Self {
                IPacketPayloadArgs {
                    width: 0,
     ...
     .finish();
        ...
        impl Default for RegionDeltaArgs<'_> {
            #[inline]
            fn default() -> Self {
                RegionDeltaArgs {
                    region_index: 0,
     ...
     .finish();
        ...
        impl Default for DPacketPayloadArgs<'_> {
            #[inline]
            fn default() -> Self {
                DPacketPayloadArgs {
                    ref_sequence: 0,
        ...
        impl Default for RoiRegionArgs<'_> {
            #[inline]
            fn default() -> Self {
                RoiRegionArgs {
                    bounds: None,
        ...
        impl Default for CorrectionDataArgs<'_> {
            #[inline]
            fn default() -> Self {
                CorrectionDataArgs {
                    roi: None,
        ...
        impl Default for CPacketPayloadArgs<'_> {
            #[inline]
            fn default() -> Self {
                CPacketPayloadArgs {
                    ref_sequence: 0,
        ...
        impl Default for CustomDataArgs<'_> {
            #[inline]
            fn default() -> Self {
